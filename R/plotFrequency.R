...
### plotting frequency from frequency object
	...
	if(is.null(attr(frequency, "call"))) stop(paste(substitute(frequency), "is no frequency object\n"))
	if(attr(frequency, "call")$func!="frequency") stop(paste(substitute(frequency), "is no frequency object\n"))
